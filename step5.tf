resource "aws_ecs_task_definition" "step5" {
  family = "step5"
 ...
 {
      "image": "619440915625.dkr.ecr.ap-east-1.amazonaws.com/imb-final-batch:3.5",
      ...
      "environment": [
        ...
        {
          "name": "S3_BASEPARAM_DATA_PATH",
          "value": "s3://hbe-test/env1/hbe/imb/baseparam/data/"
        },
        {
          "name": "S3_BASEPARAM_CNTL_PATH",
          "value": "s3://hbe-test/env1/hbe/imb/baseparam/cntl/"
        }, 
        {
          "name": "S3_TASK_DATA_PATH",
          "value": "s3://hbe-test/env1/hbe/imb/task/data/"
        },
        {
          "name": "S3_TASK_CNTL_PATH",
          "value": "s3://hbe-test/env1/hbe/imb/task/cntl/"
        },  
                {
          "name": "S3_RDY_PATH",
